...
abstract class $CartCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String userId, List<FoodItem> foodItems, double total, double subTotal});
}
...
class _$_Cart extends _Cart {
  ...
  @override
  String toString() {
    return 'Cart(userId: $userId, foodItems: $foodItems, total: $total, subTotal: $subTotal)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userId,
      const DeepCollectionEquality().hash(_foodItems), total, subTotal);
